...
<html>
<head>
<title>Lavanta Rengi G&uuml;l ve Anlam&#305;</title>
            ...
            <td width="250"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				<table width="100%"  border="2" cellpadding="0" cellspacing="0" bordercolor="#FF00FF">
                  <tr>
                    <td height="75"><h1 align="center">Lavanta Rengi  G&uuml;l </h1></td>
                  </tr>
                </table>
				</td>
              </tr>
              <tr>
				...
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="175"><div align="center"><img src="photo/lavantagul.jpg" width="145" height="150"></div></td>
                  </tr>
                </table>
				</td>
              </tr>
              ...
              <tr>
				...
				<ul>
				<br>
                  <li>&#304;lk G&ouml;r&uuml;&#351;te A&#351;k <br>
                  </li><br>
                  <li>Sihir<br>
                  </li><br>
				  <li>Gizem<br>
      ...
      <td colspan="2" align="center" valign="middle"><label>
        <input type="submit" name="button"  id="renklibuton" class="renklibuton" value="Siparis Et" />
                ...
                <p>
				  ...
				  <input type="hidden" name="urun" value="Lavanta Rengi Gül">
                </p>
                </form></td>
              </tr>
            </table>
