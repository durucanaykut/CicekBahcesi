            ...
            <td width="250"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				<table width="100%"  border="2" cellpadding="0" cellspacing="0" bordercolor="#FF00FF">
                  <tr>
                    <td height="75"><h1 align="center">Yeni Bahar</h1></td>
                  </tr>
                </table>
				</td>
              </tr>
              <tr>
				...
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="175"><div align="center"><img src="photo/yenibahar.jpg" width="145" height="150"></div></td>
                  </tr>
                </table>
				</td>
              </tr>
      ...
      <td colspan="2" align="center" valign="middle"><label>
        <input type="submit" name="button" id="renklibuton" class="renklibuton" value="Siparis Et" />
                ...
                <p>
				  ...
				  <input type="hidden" name="urun" value="Yeni Bahar">
                </p>
                </form></td>
              </tr>
            </table>
