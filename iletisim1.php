...
<html>
<head>
<title>&Ccedil;i&ccedil;ek Bah&ccedil;esi &#304;le &#304;leti&#351;im...</title>
      ...
      <tr>
        <td colspan="3"><table width="750" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="250" valign="top"><table width="100%"  border="2" cellspacing="0" cellpadding="0" bordercolor="#FF00FF">
              ...
              <tr>
				...
				<br>
				  ...
				  <br>
                  <li>Bulunan Yeni &Ccedil;i&ccedil;ek T&uuml;rleri &Ccedil;i&ccedil;ekler B&ouml;l&uuml;m&uuml;m&uuml;ze Eklenmi&#351;tir.<br>
                  </li>
				  <br>
                  <li>Hangi &Ccedil;i&ccedil;ek Kime Hediye Edilir?<br>
                  </li>
				  <br>
                  <li>&Ccedil;i&ccedil;ekler Hakk&#305;nda Bilmedikleriniz.<br>
                    <br>
                    <br>
            ...
            <td align="center" valign="top"><p class="style3">Emine Baskaya</p>
              <p class="style4">Karadeniz Teknik Üviversitesi Bilgisayar Muhendisligi</p>
              <p class="style5"><strong>ciceksatim@gmail.com<br>
              </strong></p>
              </td>
          </tr>
        </table></td>
