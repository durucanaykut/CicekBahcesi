            ...
            <td width="250"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				<table width="100%"  border="2" cellpadding="0" cellspacing="0" bordercolor="#FF00FF">
                  <tr>
                    <td height="75"><h1 align="center">A&ccedil;elya</h1></td>
                  </tr>
                </table>
				</td>
              </tr>
              <tr>
				...
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="175"><div align="center"><img src="photo/acelya.jpg" width="145" height="150"></div></td>
                  </tr>
                </table>
				</td>
              </tr>
              ...
              <tr>
				...
				<ul>
				<br>
                  <li>Ger&ccedil;ek &#350;u ki Her&#351;ey <br>
                    Bitti <br>
                  </li><br>
                  <br>
				  <br>
...
?>&nbsp;</td>
    ...
    <tr>
      <td colspan="2" align="center" valign="middle"><label>
        <input type="submit" class="renklibuton" name="button" id="renklibuton" class="renklibuton" value="Siparis Et" />
      </label></td>
    </tr>
  </table>
                <p>
                  <input type="hidden" name="kod" value="<?php echo $a;?>">
				  <input type="hidden" name="urun" value="Açelya">
                </p>
                </form></td>
              </tr>
            </table>
